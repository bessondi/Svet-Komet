! function(t, i, e) {
    ...
    function s(t, i) {
        ...
        this.extend(this, r, i, e), this.calibrationTimer = null, this.calibrationFlag = !0, this.enabled = !1, this.depthsX = [], this.depthsY = [], this.raf = null, this.bounds = null, this.ex = 0, this.ey = 0, this.ew = 0, this.eh = 0, this.ecx = 0, this.ecy = 0, this.erx = 0, this.ery = 0, this.cx = 0, this.cy = 0, this.ix = 0, this.iy = 0, this.mx = 0, this.my = 0, this.vx = 0, this.vy = 0, this.onMouseMove = this.onMouseMove.bind(this), this.onDeviceOrientation = this.onDeviceOrientation.bind(this), this.onOrientationTimer = this.onOrientationTimer.bind(this), this.onCalibrationTimer = this.onCalibrationTimer.bind(this), this.onAnimationFrame = this.onAnimationFrame.bind(this), this.onWindowResize = this.onWindowResize.bind(this), this.initialise()
    }
    var o = "Parallax",
        n = 30,
        r = {
    ...
    s.prototype.extend = function() {
        ...
        for (var o = i.createElement("div"), n = !1, r = null, a = !1, h = null, l = null, p = 0, m = this.vendors.length; m > p; p++)
            ...
            case "3D":
                if (n) {
                    var c = i.body || i.createElement("body"),
                        ...
                        y = u.style.overflow,
                        d = !1;
                    i.body || (d = !0, u.style.overflow = "hidden", u.appendChild(c), c.style.overflow = "hidden", c.style.background = ""), c.appendChild(o), o.style[l] = "translate3d(1px,1px,1px)", r = t.getComputedStyle(o).getPropertyValue(h), a = r !== e && r.length > 0 && "none" !== r, u.style.overflow = y, c.removeChild(o), d && (c.removeAttribute("style"), c.parentNode.removeChild(c))
                }
        }
        return a
